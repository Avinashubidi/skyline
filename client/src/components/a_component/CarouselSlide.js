...
function CarouselSlide(){
    ...
    // const image3 = require('../../Assets/Carousel/Carousel2.png');
  ...
  return (
    ...
    <Carousel.Item>
      <img className="d-block w-100" src={image1} alt="Image 3" />
    </Carousel.Item>
    <Carousel.Item>
      <img className="d-block w-100" src={image2} alt="Image 4" />
    </Carousel.Item>
    <Carousel.Item>
      <img className="d-block w-100" src={image1} alt="Image 5" />
    </Carousel.Item>
    <Carousel.Item>
      <img className="d-block w-100" src={image2} alt="Image 7" />
    </Carousel.Item>
  </Carousel>
